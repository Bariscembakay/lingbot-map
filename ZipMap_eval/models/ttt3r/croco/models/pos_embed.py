...
try:
    from models.ttt3r.croco.models.curope import cuRoPE2D

    RoPE2D = cuRoPE2D
except ImportError:
    raise RuntimeError("cuda-compiled RoPE2D is required for CUT3R.")
    print(
        "[TTT3R] Warning, cannot find cuda-compiled version of RoPE2D, using a slow pytorch version instead"
    )
